	...
	private void createPanel() {
		...
		role_list.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				switch(index) {
				case 0:
					theMonster.setRole(entity.EntityEnum.CS_Role.striker); break;
				case 1:
					theMonster.setRole(entity.EntityEnum.CS_Role.controller); break;
				case 2:
					theMonster.setRole(entity.EntityEnum.CS_Role.defender); break;
				case 3:
					theMonster.setRole(entity.EntityEnum.CS_Role.leader); break;
				case 4:
					theMonster.setRole(entity.EntityEnum.CS_Role.artillery); break;
				case 5:
					theMonster.setRole(entity.EntityEnum.CS_Role.brute); break;
				case 6:
					theMonster.setRole(entity.EntityEnum.CS_Role.lurker); break;
				case 7:
					theMonster.setRole(entity.EntityEnum.CS_Role.skirmisher); break;
				case 8:
					theMonster.setRole(entity.EntityEnum.CS_Role.soldier); break;
				}
			}
		});
		...
		size_list.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				switch(index) {
				case 0:
					theMonster.setSize(entity.EntityEnum.CS_Size.tiny); break;
				case 1:
					theMonster.setSize(entity.EntityEnum.CS_Size.small); break;
				case 2:
					theMonster.setSize(entity.EntityEnum.CS_Size.medium); break;
				case 3:
					theMonster.setSize(entity.EntityEnum.CS_Size.large); break;
				case 4:
					theMonster.setSize(entity.EntityEnum.CS_Size.huge); break;
				case 5:
					theMonster.setSize(entity.EntityEnum.CS_Size.gargantuan); break;
				}
			}
		});
		...
		monsterOrigin_field.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				switch(index) {
				case 0:
					theMonster.setMonsterOrigin(entity.EntityEnum.CS_Monster_Origin.aberrant); break;
				case 1:
					theMonster.setMonsterOrigin(entity.EntityEnum.CS_Monster_Origin.elemental); break;
				case 2:
					theMonster.setMonsterOrigin(entity.EntityEnum.CS_Monster_Origin.fey); break;
				case 3:
					theMonster.setMonsterOrigin(entity.EntityEnum.CS_Monster_Origin.immortal); break;
				case 4:
					theMonster.setMonsterOrigin(entity.EntityEnum.CS_Monster_Origin.shadow); break;
				}
			}
		});
		...
		monsterType_field.addActionListener( new ActionListener() {
			public void actionPerformed(ActionEvent ae) {
				...
				switch (index) {
				case 0:
					theMonster.setMonsterType(entity.EntityEnum.CS_Monster_Type.animate); break;
				case 1:
					theMonster.setMonsterType(entity.EntityEnum.CS_Monster_Type.beast); break;
				case 2:
					theMonster.setMonsterType(entity.EntityEnum.CS_Monster_Type.humanoid); break;
				case 3:
					theMonster.setMonsterType(entity.EntityEnum.CS_Monster_Type.magicalBeast); break;
				}
			}
		});
