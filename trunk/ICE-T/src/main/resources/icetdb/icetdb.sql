...
CREATE TABLE EntityM (
	...
	CONSTRAINT FK_EntityM_CombatEncounter FOREIGN KEY (CombatEncounter_id, CEname) REFERENCES CombatEncounter (CombatEncounter_id, CEname)
)
...
CREATE TABLE CharacterSheet (
	...
	CONSTRAINT FK_CharacterSheet_EntityM FOREIGN KEY (EntityM_id, name) REFERENCES EntityM (EntityM_id, name)
)
...
CREATE TABLE Team (
	...
	EntityM_id INTEGER UNIQUE,
	name VARCHAR(50) UNIQUE,
	CONSTRAINT FK_Team_EntityM FOREIGN KEY (EntityM_id, name) REFERENCES EntityM (EntityM_id, name)
)
...
CREATE TABLE TrapHazard (
	...
	CONSTRAINT FK_TrapHazard_EntityM FOREIGN KEY (EntityM_id, name) REFERENCES EntityM (EntityM_id, name)
)
...
CREATE TABLE Effect (
	...
	damage INTEGER,
	metrics VARCHAR(500),
	CONSTRAINT FK_Effect_EntityM FOREIGN KEY (EntityM_id, name) REFERENCES EntityM (EntityM_id, name),
...
CREATE TABLE Rewards (
	...
	CONSTRAINT FK_Rewards_CombatEncounter FOREIGN KEY (CombatEncounter_id, CEname) REFERENCES CombatEncounter (CombatEncounter_id, CEname) 
)
...
CREATE TABLE Tally (
	...
	CONSTRAINT FK_Tally_CombatEncounter FOREIGN KEY (CombatEncounter_id, CEname) REFERENCES CombatEncounter (CombatEncounter_id, CEname) 
)
...
CREATE TABLE Stats (
	...
	misses INTEGER,
	assists INTEGER,
	CONSTRAINT FK_Stats_CombatEncounter FOREIGN KEY (CombatEncounter_id, CEname) REFERENCES CombatEncounter (CombatEncounter_id, CEname),
