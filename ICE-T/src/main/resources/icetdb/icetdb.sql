...
CREATE TABLE CharacterSheet (
	...
	CHARA INTEGER NOT NULL DEFAULT 0,
	levelCS INTEGER NOT NULL DEFAULT 0,
	...
	roleCS INTEGER,
	sizeCS INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE Resistance (
	...
	CharacterSheet_id INTEGER NOT NULL,
	resistanceType INTEGER NOT NULL DEFAULT 0,
	resistanceValue INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE Creature (
	...
	currentHealSurges INTEGER NOT NULL DEFAULT 0,
	currentLevel INTEGER NOT NULL DEFAULT 0,
	secondWind BOOLEAN NOT NULL DEFAULT TRUE,
	tempHP INTEGER,
...
CREATE TABLE Attack (
	...
	primaryTarget VARCHAR(1000) NOT NULL DEFAULT '',
	secondaryTarget VARCHAR(1000),
	accessories VARCHAR(100),
	powerSource VARCHAR(50),
	frequency INTEGER,
	hit VARCHAR(5000) NOT NULL DEFAULT '',
	miss VARCHAR(5000),
...
CREATE TABLE A_Area (
	...
	area_range INTEGER NOT NULL DEFAULT 1,
	area_size INTEGER NOT NULL DEFAULT 1,
...
CREATE TABLE A_Close (
	...
	Attack_Type_id INTEGER NOT NULL FOREIGN KEY REFERENCES Attack_Type (Attack_Type_id),
	close_size INTEGER NOT NULL DEFAULT 1,
	closeType INTEGER NOT NULL DEFAULT 0
)
...
CREATE TABLE A_Melee (
	...
	Attack_Type_id INTEGER NOT NULL FOREIGN KEY REFERENCES Attack_Type (Attack_Type_id),
	melee_reach INTEGER NOT NULL DEFAULT 1
)
...
CREATE TABLE A_Range (
	...
	Attack_Type_id INTEGER NOT NULL FOREIGN KEY REFERENCES Attack_Type (Attack_Type_id),
	L_range INTEGER NOT NULL DEFAULT 1,
	S_range INTEGER NOT NULL DEFAULT 1
)
